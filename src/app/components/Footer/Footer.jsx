    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.footerCont}>
        <div className={styles.flexCont}>
          ...
          {/*Phone and Email*/}
          <address className={`${styles.phoneEmailCont}`}>
            {/*Phone*/}
            <div className={`${styles.contentCont}`}>
              <img
        ...
        {/*Footer Links*/}
        <nav className={styles.flexCont} aria-label="Footer Links">
          {/*First group of links*/}
          <h3 className="sr-only">About Fylo</h3>
          <ul className={`flex-col ${styles.linksCont}`}>
            <li>
          ...
          <h3 className="sr-only">Legal & Contact</h3>
          <ul className={`flex-col ${styles.linksCont}`}>
            <li>
              <a className={styles.links} href="">
                Contact Us
        ...
        {/*Social Links*/}
        <nav
          className={styles.sociaLinksCont}
          aria-label="Follow Fylo on Social media"
        >
